...
export interface ApiUploadedMediaUploadedMedia extends Schema.CollectionType {
  collectionName: 'uploaded_medias';
  info: {
    singularName: 'uploaded-media';
    pluralName: 'uploaded-medias';
    displayName: 'Uploaded Media';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::uploaded-media.uploaded-media',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::uploaded-media.uploaded-media': ApiUploadedMediaUploadedMedia;
